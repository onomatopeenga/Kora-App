...
class TaskSchedule(val duration: Long, val timeUnit: TimeUnit) {

    companion object {
        fun build(duration: Long, timeUnit: String): TaskSchedule {
            ...
            return TaskSchedule(realDuration, realTimeUnit)
        }
