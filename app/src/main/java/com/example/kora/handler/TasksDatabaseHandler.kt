package com.example.kora.handler
...
import com.example.kora.model.TasksModel
...
class TasksDatabaseHandler(context: Context?) :
    ...
    val getallTasks: List<Any>
        get() {
            val taskList: MutableList<TasksModel> = ArrayList<TasksModel>()
            var cur: Cursor? = null
            db!!.beginTransaction()
            try {
